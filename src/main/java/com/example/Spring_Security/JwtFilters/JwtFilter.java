package com.example.Spring_Security.JwtFilters;
...
//        4. Extract the JWT from the Authorization header by the removing the "Bearer " token.
...
//        10. set the details about the request in the Authentication object.
            authenticationToken.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));

//         11. set the Authentication Object in the  SecurityContextHolder
